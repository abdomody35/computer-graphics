...
void drawCircleBresenham(GrayscaleImage &image, const Point &center, int radius, bool fill = false, Byte color = 255)
{
    if (radius <= 0)
    {
...
int main()
{
    ...
    drawCircleBresenham(image, center, radius, true, 128);
